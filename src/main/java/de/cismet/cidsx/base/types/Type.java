...
public enum Type {
    ...
    BYTE(byte.class.getName(), true),
    SHORT(short.class.getName(), true),
    INTEGER(int.class.getName(), true),
    FLOAT(float.class.getName(), true),
    LONG(long.class.getName(), true),
    DOUBLE(double.class.getName(), true),
    BOOLEAN(boolean.class.getName(), true),
    CHAR(char.class.getName(), true),
    STRING(String.class.getName(), true),
    DATE(Date.class.getName(), true),
    ENTITY("Sirius.server.middleware.types.MetaObject", false),
    ENTITY_REFERENCE("Sirius.server.middleware.types.LightweightMetaObject", false),
    ENTITY_INFO("Sirius.server.middleware.types.MetaClass", false),
    NODE("Sirius.server.middleware.types.Node", false),
    JAVA_CLASS(Object.class.getName(), false),
    JAVA_SERIALIZABLE(Serializable.class.getName(), false),
    ...
    public static Type typeForJavaClass(final Class javaClass) {
        if (javaClass.equals(byte.class) || javaClass.equals(Byte.class)) {
            ...
            javaClass.equals(boolean.class) ||
            javaClass.equals(Boolean.class) ||
            javaClass.equals(boolean[].class) ||
            javaClass.equals(Boolean[].class)
        ) {
            ...
            javaClass.equals(Character.class) ||
            javaClass.equals(char[].class) ||
            javaClass.equals(Character[].class)
        ) {
            return CHAR;
            ...
            javaClass.getName().equals("de.cismet.cids.dynamics.CidsBean") ||
            ...
            javaClass.getName().equals("de.cismet.cidsx.server.api.types.CidsClass") ||
            ...
            javaClass.getName().equals("de.cismet.cidsx.server.api.types.CidsNode") ||
