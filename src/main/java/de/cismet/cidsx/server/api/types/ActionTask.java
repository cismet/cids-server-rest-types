...
public class ActionTask extends ActionInfo implements Key {
    ...
    /**
     * Provides information about server actions and their parameters as well as 
     * information about a running task (executed action). The ActionTask is currently
     * also used as template object to create a new action by filling the <i>parameters</i>
     * map.
     *
     * @version  1.0
     */
    ...
    /**
     * Initialises the action info related properties of the action task from 
     * an action info object. 
     * 
     * @param actionInfo 
     */
    ...
    /**
     * Sets the action info related properties of the action task from 
     * an action info object.
     * 
     * @param actionInfo
     */
